...
//	        tableDichVu.setItems(observableList);
	...
	void loadThongTin () {
		...
		tienPhong = GD_ThanhToanController.tienPhong;
		tienDV = GD_ThanhToanController.tienPhong;
		tienThue = GD_ThanhToanController.tienPhong;
		chietKhau = GD_ThanhToanController.tienPhong;
		tienkm = GD_ThanhToanController.tienPhong;
		tienNhan = GD_ThanhToanController.tienNhan;
		tong = GD_ThanhToanController.tong;
		tienThua = GD_ThanhToanController.tienThua;
		txtTongTienDichVu.setText(String.valueOf(tienDV));
		txtTongTien.setText(String.valueOf(tienPhong));
		txtTienThueVAT.setText(String.valueOf(tienThue));
		txtGiamGia.setText(String.valueOf(tienkm + chietKhau));
		txtThanhToan.setText(String.valueOf(tong));
		txtTienKhach.setText(String.valueOf(tienNhan));
